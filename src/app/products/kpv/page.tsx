...
export default function KPVPage() {
	...
	const mgOptions = [
		{ value: '5mg', price: 31.99, originalPrice: 35.99, image: '/products/KPV/KPV 5mg.png', inStock: true },
		{ value: '10mg', price: 54.99, originalPrice: 61.99, image: '/products/KPV/KPV 10mg.png', inStock: true }
	]
	...
	const currentImage = currentOption?.image || '/products/KPV/KPV 10mg.png'
	...
	return (
		<div className="min-h-screen bg-background">
			<Header />
			<ProductNavigation currentProductId="kpv" />
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<nav className="mb-6 pt-4">
						<ol className="flex items-center space-x-2 text-sm text-muted-foreground flex-wrap gap-y-1">
							...
							<li className="whitespace-nowrap">/</li>
							<li className="text-foreground font-medium whitespace-nowrap">{`KPV ${selectedMG}`}</li>
						</ol>
					</nav>

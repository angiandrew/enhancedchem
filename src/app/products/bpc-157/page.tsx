			...
			<main className="pt-24 pb-16">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
						{/* Product Image */}
						<motion.div 
							className={`sticky top-28 flex justify-center lg:justify-start ${selectedMG === '10mg' ? 'pt-8 lg:pt-12' : ''}`}
							initial={{ opacity: 0, x: -20 }}
							animate={{ opacity: 1, x: 0 }}
							transition={{ duration: 0.5 }}
						>
							{selectedMG === '10mg' ? (
								// For 10mg: No box, enlarged image (shrunk by 10% from previous size)
								<AnimatePresence mode="wait">
									...
									>
										<div style={{ transform: 'scale(1.215)', transformOrigin: 'center' }}>
											<Image
												src={currentImage}
								...
								// For 5mg: Keep original box design

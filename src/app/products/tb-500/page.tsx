...
export default function TB500Page() {
	...
	return (
		<div className="min-h-screen bg-background">
			<Header />
			<ProductNavigation currentProductId="tb-500" />
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<nav className="mb-6 pt-4">
						<ol className="flex items-center space-x-2 text-sm text-muted-foreground flex-wrap gap-y-1">
							...
							<li className="whitespace-nowrap">/</li>
							<li className="text-foreground font-medium whitespace-nowrap">{`TB-500 ${selectedMG}`}</li>
						</ol>
					</nav>
						...
						<div className="lg:sticky lg:top-28">
							<ProductImageCarousel
								slides={
									selectedMG === '10mg'
										? [
												{ src: currentImage, alt: `TB-500 ${selectedMG}` },
												{ src: '/COAs/3rd party testing/TB500-10mg.JPG', alt: 'TB-500 10mg Certificate of Analysis', isCoa: true },
											]
										: [{ src: currentImage, alt: `TB-500 ${selectedMG}` }]
								}
								priority

...
export default function CJC1295NoDACPage() {
	...
	const mgOptions = [
		...
		{ value: '10mg', price: 64.99, originalPrice: 71.99, image: '/products/CJC NO DAC/CJC-1295 10mg.png', inStock: true }
	]

	const currentOption = mgOptions.find(option => option.value === selectedMG)
	const currentPrice = currentOption?.price || 64.99
	const currentOriginalPrice = currentOption?.originalPrice || 71.99
	...
	const handleAddToCart = () => {
		...
		for (let i = 0; i < quantity; i++) {
			addItem({
				id: `cjc-1295-no-dac-${selectedMG === '5mg' ? '5mg' : ''}`,
				name: `CJC-1295 No DAC (${selectedMG})`,
				price: currentPrice,
				image: currentImage
			})
		}
	...
	return (
		<div className="min-h-screen bg-background">
			<Header />
			<ProductNavigation currentProductId="cjc-1295-no-dac" />
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<nav className="mb-6 pt-4">
						<ol className="flex items-center space-x-2 text-sm text-muted-foreground flex-wrap gap-y-1">
							...
							<li className="whitespace-nowrap">/</li>
							<li className="text-foreground font-medium whitespace-nowrap">CJC-1295 No DAC ({selectedMG})</li>
						</ol>
					</nav>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-start">
						...
						<div className="lg:sticky lg:top-28 overflow-hidden rounded-lg">
								<div className="relative aspect-square overflow-hidden">
									<Image
										src={currentImage}
										alt={`CJC-1295 No DAC (${selectedMG})`}
										fill

...
export default function CJC1295NoDACPage() {
	...
	const mgOptions = [
		{ value: '5mg', price: 129.99, originalPrice: 179.99, image: '/products/CJC NO DAC/CJC1295 5mg NO DAC.png', inStock: true },
		{ value: '10mg', price: 219.99, originalPrice: 299.99, image: '/products/CJC NO DAC/CJC NO DAC 10mg.png', inStock: true }
	]

	const currentOption = mgOptions.find(option => option.value === selectedMG)
	const currentPrice = currentOption?.price || 219.99
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<nav className="mb-6">
						<ol className="flex items-center space-x-2 text-sm text-muted-foreground">
							...
							<li>/</li>
							<li className="text-foreground font-medium">CJC-1295 No DAC ({selectedMG})</li>
						</ol>
					</nav>

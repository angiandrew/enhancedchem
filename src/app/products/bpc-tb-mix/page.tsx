...
export default function BpcTbMixPage() {
	...
	const currentImage = currentOption?.image || '/products/bpc-tb-mix/BPC_TB 5_5.png'
						...
						<div className="lg:sticky lg:top-28">
							<ProductImageCarousel
								slides={
									selectedMG === '5mg'
										? [
												{ src: currentImage, alt: `BPC-157 + TB-500 Mix ${selectedMG}` },
												{ src: '/COAs/3rd party testing/bpctb55.jpg', alt: 'BPC-TB Mix 5mg Certificate of Analysis', isCoa: true },
											]
										: [{ src: currentImage, alt: `BPC-157 + TB-500 Mix ${selectedMG}` }]
								}
								priority

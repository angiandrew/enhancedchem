...
export default function BpcTbMixPage() {
	...
	const mgOptions = [
		{ value: '5mg', price: 149.99, originalPrice: 199.99, image: '/products/bpc-tb-mix/BPC_TB Blend 5_5.png', inStock: true },
		{ value: '10mg', price: 199.99, originalPrice: 249.99, image: '/products/bpc-tb-mix/BPC_TB Blend 10_10.png', inStock: true }
	]

	const currentOption = mgOptions.find(option => option.value === selectedMG)
	const currentPrice = currentOption?.price || 149.99
	const currentOriginalPrice = currentOption?.originalPrice || 199.99
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<nav className="mb-6">
						<ol className="flex items-center space-x-2 text-sm text-muted-foreground">
							...
							<li>/</li>
							<li className="text-foreground font-medium">BPC-157 + TB-500 Mix {selectedMG}</li>
						</ol>
					</nav>

...
export default function Glp2TzPage() {
	const [quantity, setQuantity] = useState(1)
	const { addItem } = useCart()

	const currentPrice = 79.99
	const currentOriginalPrice = 88.99
	const currentImage = '/products/GLP-2TZ/GLP2TZ.jpeg'
	...
	return (
		<div className="min-h-screen bg-background">
			<Header />
			<ProductNavigation currentProductId="glp-2tz" />
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<nav className="mb-6 pt-4">
						<ol className="flex items-center space-x-2 text-sm text-muted-foreground flex-wrap gap-y-1">
							...
							<li className="whitespace-nowrap">/</li>
							<li className="text-foreground font-medium whitespace-nowrap">GLP-2TZ</li>
						</ol>
					</nav>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-start">
						<div className="lg:sticky lg:top-28">
							<ProductImageCarousel
								slides={[{ src: currentImage, alt: 'GLP-2TZ' }]}
								priority
							/>
						</div>

...
export default function NAD500mgPage() {
	const [quantity, setQuantity] = useState(1)
	const { addItem } = useCart()

	const currentPrice = 64.99
	const currentOriginalPrice = 72.99
	const currentImage = '/products/NAD%2B%20500MG/NAD%2B%20500mg.png'
	...
	return (
		<div className="min-h-screen bg-background">
			<Header />
			<ProductNavigation currentProductId="nad-500mg" />
			<main className="pt-36 pb-16">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<ol className="flex items-center space-x-2 text-sm text-muted-foreground flex-wrap gap-y-1">
							...
							<li className="whitespace-nowrap">/</li>
							<li className="text-foreground font-medium whitespace-nowrap">NAD+ 500mg</li>
						</ol>
					</nav>

					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-start">
						{/* Product Images - carousel with dots */}
						<div className="lg:sticky lg:top-28">
							<ProductImageCarousel
								slides={[
									{ src: currentImage, alt: 'NAD+ 500mg' },
									{ src: '/COAs/3rd party testing/NAD500.jpg', alt: 'NAD+ 500mg Certificate of Analysis', isCoa: true },
								]}
								priority
							/>
						</div>
						...
						<div className="bg-card rounded-2xl p-4 sm:p-8 border border-border shadow-sm">
							...
							<div className="space-y-4">
								...
								<div className="flex justify-between py-2 border-b border-border/50">
									...
									<span className="text-muted-foreground">53-84-9</span>
								</div>
								<div className="flex justify-between py-2 border-b border-border/50">
									<span className="font-medium text-foreground">Molecular Formula:</span>
									<span className="text-muted-foreground">C₂₁H₂₇N₇O₁₄P₂</span>
								</div>
								<div className="flex justify-between py-2 border-b border-border/50">

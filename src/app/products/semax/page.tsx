...
export default function SemaxPage() {
	...
	const currentPrice = 41.99
	const currentOriginalPrice = 46.99
	...
	return (
		<div className="min-h-screen bg-background">
			<Header />
			<ProductNavigation currentProductId="semax" />
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<nav className="mb-6 pt-4">
						<ol className="flex items-center space-x-2 text-sm text-muted-foreground flex-wrap gap-y-1">
							...
							<li className="whitespace-nowrap">/</li>
							<li className="text-foreground font-medium whitespace-nowrap">Semax 10mg</li>
						</ol>
					</nav>

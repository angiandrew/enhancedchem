...
export default function Melanotan2Page() {
	...
	const currentImage = '/products/Melanotan 2 10mg/Melanotan 2 10mg.png'
	...
	return (
		<div className="min-h-screen bg-background">
			<Header />
			<ProductNavigation currentProductId="melanotan-2" />
			<main className="pt-36 pb-16">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<ol className="flex items-center space-x-2 text-sm text-muted-foreground flex-wrap gap-y-1">
							...
							<li className="whitespace-nowrap">/</li>
							<li className="text-foreground font-medium whitespace-nowrap">Melanotan 2 10mg</li>
						</ol>
					</nav>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-start">
						...
						<div className="lg:sticky lg:top-28">
							<ProductImageCarousel
								slides={[
									{ src: currentImage, alt: 'Melanotan 2 10mg' },
									{ src: '/COAs/3rd party testing/MT2.jpg', alt: 'Melanotan 2 Certificate of Analysis', isCoa: true },
								]}
								priority
							/>
						</div>
						...
						<div className="bg-card rounded-2xl p-4 sm:p-8 border border-border shadow-sm">
							...
							<div className="space-y-4">
								...
								<div className="flex justify-between py-2 border-b border-border/50">
									...
									<span className="text-muted-foreground">121062-08-6</span>
								</div>
								<div className="flex justify-between py-2 border-b border-border/50">

...
export default function CJC1295NoDAC5mgPage() {
	...
	return (
		<div className="min-h-screen bg-background">
			<Header />
			<ProductNavigation currentProductId="cjc-1295-no-dac-5mg" />
			<main className="pt-36 pb-16">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<ol className="flex items-center space-x-2 text-sm text-muted-foreground flex-wrap gap-y-1">
							...
							<li className="whitespace-nowrap">/</li>
							<li className="text-foreground font-medium whitespace-nowrap">CJC-1295 No DAC (5mg)</li>
						</ol>
					</nav>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-start">
						...
						<div className="lg:sticky lg:top-28">
							<ProductImageCarousel
								slides={[
									{ src: currentImage, alt: 'CJC-1295 No DAC (5mg)' },
									{ src: '/COAs/3rd party testing/cjc no dac5.jpg', alt: 'CJC-1295 No DAC 5mg Certificate of Analysis', isCoa: true },
								]}
								priority
							/>
						</div>

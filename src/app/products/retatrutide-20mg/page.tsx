...
export default function Retatrutide20mgPage() {
	...
	const product = {
		...
		description: 'Retatrutide is a triple agonist peptide targeting GLP-1, GIP, and glucagon receptors. This research-grade peptide in 20mg concentration is designed for scientific studies and laboratory research purposes only.',
		inStock: true,
		label: 'Premium',
		discount: 10,
		specs: {

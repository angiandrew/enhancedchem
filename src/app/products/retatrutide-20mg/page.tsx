...
export default function Retatrutide20mgPage() {
	...
	const currentPrice = currentOption?.price || 155.54
	const currentOriginalPrice = currentOption?.originalPrice || 172.82
		...
		<div className="min-h-screen bg-background">
			<ProductStructuredData
				product={{
					...
					description: 'Retatrutide 20mg - Triple agonist peptide (GLP-1, GIP, glucagon) for research. Premium quality, third-party tested.',
					price: currentPrice,
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-start">
						...
						<div className="lg:sticky lg:top-28">
							<div className={`relative aspect-square bg-secondary/30 rounded-lg border border-border overflow-hidden ${!isInStock ? 'opacity-75' : ''}`}>
								<Image
									src={currentImage}

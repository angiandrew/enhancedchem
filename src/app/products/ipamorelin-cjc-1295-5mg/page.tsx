...
export default function IpamorelinCJC12955mgPage() {
	...
	return (
		<div className="min-h-screen bg-background">
			<Header />
			<ProductNavigation currentProductId="ipamorelin-cjc-1295-5mg" />
			<main className="pt-36 pb-16">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<ol className="flex items-center space-x-2 text-sm text-muted-foreground flex-wrap gap-y-1">
							...
							<li className="whitespace-nowrap">/</li>
							<li className="text-foreground font-medium whitespace-nowrap">Ipamorelin/CJC-1295 (no DAC) 5mg</li>
						</ol>
					</nav>

...
export default function Tesamorelin10mgPage() {
	...
	return (
		<div className="min-h-screen bg-background">
			<Header />
			<ProductNavigation currentProductId="tesamorelin-10mg" />
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<nav className="mb-6 pt-4">
						<ol className="flex items-center space-x-2 text-sm text-muted-foreground flex-wrap gap-y-1">
							...
							<li className="whitespace-nowrap">/</li>
							<li className="text-foreground font-medium whitespace-nowrap">Tesamorelin 10mg</li>
						</ol>
					</nav>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-start">
						<div className="lg:sticky lg:top-28">
							<ProductImageCarousel
								slides={[{ src: currentImage, alt: 'Tesamorelin 10mg' }]}
								priority
							/>
						</div>
					...
					<div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:p-8 lg:gap-12">
						...
						<div className="bg-card rounded-2xl p-4 sm:p-8 border border-border shadow-sm">
							...
							<p className="text-muted-foreground leading-relaxed">
								Tesamorelin is a synthetic peptide analog composed of a defined amino acid sequence produced through controlled laboratory synthesis. It is manufactured for analytical characterization and experimental laboratory applications involving peptide structure and biochemical research. This material is supplied strictly for laboratory research use in controlled, non-clinical environments.
							</p>
						</div>
					</div>

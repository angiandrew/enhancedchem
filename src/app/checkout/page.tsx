					...
					{orderCompleted ? (
						...
						<div className="max-w-4xl mx-auto">
							<div className="text-center mb-12">
								...
								<h1 className="font-serif text-4xl md:text-5xl font-semibold mb-4 text-green-900">
									Order Submitted Successfully!
								</h1>
								
								{orderNumber && (
									<div className="bg-green-100 border-2 border-green-500 rounded-lg p-6 mb-8 shadow-md max-w-md mx-auto">
										<p className="text-sm text-green-800 mb-2 font-medium">Your Order Number:</p>
										<p className="text-2xl font-bold text-green-950">{orderNumber}</p>
									</div>
								)}
								
								<div className="bg-blue-50 border-2 border-blue-400 rounded-lg p-8 mb-8 shadow-md">
									<h2 className="font-serif text-2xl font-semibold mb-4 text-blue-900">
										Next Steps
									</h2>
									<p className="text-lg text-blue-800 mb-6 leading-relaxed">
										Thank you for your order! We&apos;ve sent payment instructions to <strong>{customerEmail}</strong>. 
										Please check your email (including spam folder) for detailed instructions on how to complete your payment.
									</p>
									<div className="bg-white border border-blue-300 rounded-lg p-6 text-left">
										<h3 className="font-semibold text-blue-900 mb-3">What to expect in your email:</h3>
										<ul className="space-y-2 text-blue-800">
											<li className="flex items-start gap-2">
												<CheckCircle className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
												<span>Your order number: <strong>{orderNumber}</strong></span>
											</li>
											<li className="flex items-start gap-2">
												<CheckCircle className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
						...
						<div className="lg:col-span-2 space-y-8">
							...
							{!isVerificationComplete && (
								<div className="bg-amber-100 border-2 border-amber-500 rounded-lg p-6 shadow-md">
									<div className="flex items-start gap-4">
										<AlertCircle className="w-6 h-6 text-amber-700 shrink-0 mt-0.5" />
										<div>
											<h3 className="font-serif text-lg font-semibold mb-2 text-amber-950">
							...
							<div className={`rounded-lg border-2 shadow-[var(--shadow-elevated)] p-6 md:p-8 transition-all ${
								isVerificationComplete 
								...
								<div className="flex items-center justify-between mb-6">
									...
									{isVerificationComplete && (
										<button
											...
											className="flex items-center gap-2 text-green-700 hover:text-green-800 transition-colors text-sm font-medium"
										>
								...
								{isVerificationCollapsed ? (
									<div className="bg-green-200 border-2 border-green-600 rounded-lg p-4 shadow-md">
										<div className="flex items-center gap-3">
											<CheckCircle className="h-5 w-5 text-green-700 shrink-0" />
											<div className="flex-1">
												<p className="text-sm font-bold text-green-950">Verification Complete</p>
												<p className="text-xs text-green-900 mt-1 font-medium">
							...
							{/* Order Items */}
							<div className="bg-card rounded-lg border-2 border-border shadow-[var(--shadow-elevated)] p-6 md:p-8">
								<h2 className="font-serif text-2xl font-semibold mb-6">
									Order Items
								</h2>
								<div className="space-y-4">
									{items.map((item) => (
										<div key={item.id} className="flex items-center justify-between p-4 border-2 border-border bg-secondary/50 rounded-lg hover:border-primary hover:shadow-md transition-all">
											<div className="flex items-center gap-4">
												<div className="w-20 h-20 bg-secondary/30 rounded-lg flex items-center justify-center border border-border overflow-hidden shrink-0">
													<Image
														src={item.image}
														alt={item.name}
														width={80}
														height={80}
														className="object-contain rounded-lg max-w-full max-h-full p-2"
													/>
												</div>
												<div>
							...
							{/* Shipping Address */}
							<div className={`bg-card rounded-lg border-2 shadow-[var(--shadow-elevated)] p-6 md:p-8 transition-all ${
								isAddressComplete 
								...
								<div className="space-y-4">
									...
									>
										<div className="flex items-center gap-3 mb-3">
											...
											<div className="w-8 h-8 bg-purple-700 rounded text-white text-xs flex items-center justify-center font-bold shadow-md">Z</div>
										...
										<div className={`rounded-lg p-3 border-2 ${
											...
											<p className={`text-sm font-medium ${
												...
												Send payment to <strong>enhancedchem4@gmail.com</strong> via Zelle. Include your order number in the memo.
											</p>
										</div>
									</div>
									...
									>
										<div className="flex items-center gap-3 mb-3">
											...
											<div className="w-8 h-8 bg-orange-600 rounded text-white text-xs flex items-center justify-center font-bold shadow-md">₿</div>
									...
									>
										<div className="flex items-center gap-3 mb-3">
											...
											<div className="w-8 h-8 bg-blue-600 rounded text-white text-xs flex items-center justify-center font-bold shadow-md">V</div>
							...
							<div className="lg:col-span-1">
								<div className="bg-card rounded-lg border-2 border-border shadow-[var(--shadow-elevated)] p-6 sticky top-24">
									<div>
						...
						{/* Research Disclaimer */}
						<div className="mt-12 bg-red-100 border-2 border-red-500 rounded-lg p-6 max-w-7xl mx-auto shadow-md">
							<h3 className="font-serif text-lg font-semibold mb-2 flex items-center gap-2 text-red-950">

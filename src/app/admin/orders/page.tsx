...
// CRITICAL: This page includes Test order support (isTest, Mark test button, Total Revenue/Orders exclude test).
// Preserve these when merging branches — see scripts/check-critical-features.mjs and .github/workflows/check-critical-features.yml.
					...
					<div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-4">
						<div className="bg-white rounded-lg shadow-sm p-6">
							...
							<div className="text-2xl font-bold text-gray-900 mt-1">
								{orders.filter((o) => !o.isTest).length}
							</div>

...
export function middleware(request: NextRequest) {
  ...
  response.headers.set(
    'Content-Security-Policy',
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://static.affiliatly.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self'; connect-src 'self' https://api.geoapify.com https://static.affiliatly.com; frame-ancestors 'none';"
  )
